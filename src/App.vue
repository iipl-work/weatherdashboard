...
// var weathrapi = "http://api.openweathermap.org/data/2.5/weather?q=palakollu&appid=7c775f7c5b40eb93622b1924a4e2c7ea"
// mounted () {
//     axios
//       .get('https://api.coindesk.com/v1/bpi/currentprice.json')
//       .then(response => (this.info = response))
//   }
// console.log(weathrapi)
export default {
  name: "app",
  props: [],
...
"zu" : "Zulu"
  ...
  data() {
    return {
      ...
      errorMsg: "",
      weatherDetails: true,
      location: "Hyderabad", // raw location from input
      lat: "40.7128", // raw latitude from google maps api response
      long: "74.006", // raw longitude from google maps api response
      completeWeatherApi: "", // weather api string with lat and long
      rawWeatherData: "", // raw response from weather api
      currentWeather: {
        full_location: "Hyderabad,T.S,India", // for full address
        formatted_lat: "40.7128°N", // for N/S
        formatted_long: "74.006°W", // for E/W
        time: "Tue,May 4,2021 5:04 PM",
        temp: "3",
        todayHighLow: {
          todayTempHigh: "4",
  ...
  methods: {
    ...
    //          resolve(coords);
    //        } else {
    //          alert("getting data from the location");
    //        }
    //      });
    //    });
    //  },
  ...
  //    var visibilityInMiles = this.rawWeatherData.currently.visibiliy;
